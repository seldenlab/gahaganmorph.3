...
Previous studies have demonstrated a significant difference in shape between Gahagan bifaces recovered from the Mounds Plantation and George C. Davis sites [@RN11783]. The results presented here demonstrate no significant intrasite differences in shape, but support an inverse relationship in the size of Gahagan bifaces found in earlier and later contexts at Mounds Plantation and George C. Davis. In burials at Mounds Plantation, the Caddo were `selecting` for Gahagan bifaces that were significantly smaller in later contexts; a pattern that is inverted at George C. Davis.
