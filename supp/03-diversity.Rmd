...
# identify vars for plot
context <- gahagan_pct$context
types <- c("alba", "celt","catahoula", "friley", "gahagan", "harrell",
           "reed", "scallorn", "coles_creek", "hickory_engraved",
           "holly_fine_engraved", "kiam_incised")

# plot figure
ggplot(gahagan_pct, aes(x = context, y = perc, fill = types)) +
