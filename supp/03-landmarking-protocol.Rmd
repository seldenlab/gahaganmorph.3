...
The first 3D landmarking protocol ([LM3d1](https://github.com/aksel-blaise/gahaganmorph2/blob/master/analysis/landmarking-protocol.md)) was used in an analysis of Gahagan bifaces focused only upon the plan view (lateral/basal edges), and enlisted _auto3dgm_ to achieve the principal alignments needed to assign the front and back to each face [@RN21001]. While basic, this landmarking protocol generated the requisite framework needed to begin constructing different suites of design-based `reference geometry` that can be tailored to address specific research questions.
