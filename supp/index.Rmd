...
```{r b.context, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Comparison of Gahagan bifaces from cache and individual contexts. In the comparison, gray dots represent cache contexts, and black represent individual."}
