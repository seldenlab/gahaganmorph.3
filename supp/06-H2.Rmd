...
## _Hypothesis 2: Gahagan bifaces included in Caddo burials as a cache offering differ in morphology from those placed with an individual._
...
```{r load geomorph.h2, setwd, and load data, echo=TRUE, warning=FALSE, eval = FALSE}
# load libraries
library(here)
library(geomorph)
library(tidyverse)
...
```{r gpa.h2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, eval = FALSE}
Y.gpa <- gpagen(coords, 
              PrinAxes = TRUE, 
...
```{r centsize.box.h2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, eval = FALSE}
...
```{r pca1.h2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, eval = FALSE}
# principal components analysis
...
```{r pca2.h2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, eval = FALSE}
...
```{r m-shapes.h2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, eval = FALSE}
...
knitr::include_graphics('images/cacheind-bcontext-figure.png')
```
