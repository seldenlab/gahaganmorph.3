...
included in mortuary offerings provide evidence of material culture
shifts that convey the spatial and temporal dynamics of local and
regional burial traditions. Among the constituent groups associated with
the Caddo Confederacy in the American Southeast, contextual differences
in burial practices associated with Gahagan bifaces are indicative of
two discrete burial traditions; one where a Gahagan biface was placed
\emph{atop or alongside an individual}, and another where a cache of
Gahagan bifaces was included \emph{along the northern wall of the burial
feature}. This study asks whether mortuary assemblage diversity and
evenness increases through time, whether Gahagan biface morphology
differs by burial tradition, and whether Gahagan biface morphology
associated with each burial tradition changes through time. A seriation
of mortuary contexts followed by an analysis of mortuary assemblage
diversity highlights a significant increase in mortuary assemblage
diversity and evenness through time, where assemblages of the earliest
mortuary offerings at each site express lower diversity and evenness
than later contexts. Results also indicate that Gahagan biface shape
differs between the two Caddo burial traditions, indicating discrete
communities of practice delimited by biface placement and morphology.
Bifaces included as offerings with \emph{individuals} differ through
time from those placed in \emph{caches}; initially in size, and
subsequently in shape. Bifaces found in \emph{caches} express
morphological stability through time as the two burial traditions
mature, while Caddo mortuary offerings become both more diverse and
evenly distributed among the diagnostic types. These findings provide
the basis for a discussion of the establishment, maintenance, and
evolution of a unique Caddo burial practice that occurs during their
transition from a more mobile horticulturist lifeway to one of
emergent---and increasingly sedentary---agriculturalists.
\end{abstract}
