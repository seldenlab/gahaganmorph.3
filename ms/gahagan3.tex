...
burial feature}. This study asks whether assemblage diversity and
evenness---for mortuary contexts associated with Gahagan
bifaces---increases through time, and whether Gahagan biface morphology
may differ based on differences in burial contexts. A seriation of
mortuary contexts paired with an analysis of mortuary assemblage
diversity highlights changes to Caddo burial assemblages through time,
where the earliest contexts express lower diversity and evenness than
later contexts. Results also indicate that Gahagan biface morphology
differs between Caddo burial traditions, indicating discrete communities
of practice related to both \texttt{object\ placement} and
\texttt{shape\ preference}. These findings comprise the basis for a
