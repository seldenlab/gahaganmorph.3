...
{\centering \includegraphics[width=0.85\linewidth]{img/fig02} 
...
\caption{Network of associated diagnostic artifacts recovered with Gahagan bifaces. The thicker and darker the line between contexts, the larger the number of co-present diagnostic artifacts.}\label{fig:associated.net}
\end{figure}
...
\cite{RN6995}. To assess whether shape differs by context, Procrustes
ANOVAs \cite{RN7046} were run that enlist effect-sizes (z-scores)
