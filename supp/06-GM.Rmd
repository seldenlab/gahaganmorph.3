...
This hypothesis is tested using Gahagan bifaces recovered from one of two discrete contexts; one interred as part of a _cache_, and the other placed atop or alongside _individuals_. Distinct Caddo burial practices may have constrained local morphological requirements, highlighting differential `shape preference`.
...
# does one context display greater **size** variation among 
# individuals relative to the other group?
