...
```{r MAP, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Locations of the Mounds Plantation, Gahagan Mound, and George C. Davis sites, and geographic extent of the southern Caddo area in white."}
