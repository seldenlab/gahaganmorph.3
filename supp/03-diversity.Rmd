...
# Simpson diversity
data$D1 <- diversity(data[3:15], index = "simpson")
D1 <- data$D1
```
...
The figure above shows higher diversity and evenness in later contexts. Is there a significant increase in diversity and evenness between the initial burial context at each site that included Gahagan bifaces, and those that occur later?
