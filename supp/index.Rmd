--- 
title: "Morphological trajectories suggest changes in cultural preference associated with Gahagan bifaces from Caddo burial contexts"
author: 
...
- Gahagan bifaces from BPs 1, 5, and 8 (Early) and BP2 (Late) contexts do not differ in _shape_
- Gahagan bifaces from Early and Late contexts **differ significantly** in _size_
  - Early bifaces are **significantly larger** than Late bifaces
  
```{r h1a.box, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Difference in centroid size between Gahagan bifaces from BPs 1, 5, and 8 (Early) and BP 2 (Later) contexts at the Mounds Plantation site."}
...
- Gahagan bifaces from F134 (Early) and F119 (Late) contexts do not differ in _shape_
- Gahagan bifaces from Early and Late contexts **differ significantly** in _size_
  - Late bifaces are **significantly larger** than Early bifaces

```{r h1b.box, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Difference in centroid size between Gahagan bifaces from F134 (Early) and F119 (Later) contexts at the George C. Davis site."}
...
Hypothesis 2 is tested using two broad categories of Gahagan bifaces; one interred as part of a _cache_, and the other placed atop or alongside _individuals_. Distinct Caddo burial practices may have constrained local morphological requirements, highlighting aspects of differential `design intent`.
...
```{r h2.box, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="There is a significant difference Gahagan biface shapes from _cache_ (left), _individual_ (right), contexts. In the comparison of contexts, _cache_ is presented in gray, and _individual_ in black."}
