...
```{r MAP, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Location of sites with assemblages included in the study. Ancestral Caddo area outlined in white."}
...
- The hypothesis that the morphological diversity of Gahagan bifaces increases through the technological life cycle is rejected. Those Gahagan bifaces from _initial_ contexts placed atop or alongside an individual expressed a greater diversity in size than all other categories. Thus, for the comparison of Gahagan biface morphological diversity through time among contexts, those found with individuals express stability shape diversity, but the inverse of the hypothesis in size (becoming less diverse in size through time), while those from cache contexts express morphological stability in shape and size through time.
