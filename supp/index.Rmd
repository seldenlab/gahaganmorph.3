...
Hypothesis 1 is tested using two samples of Gahagan bifaces from Caddo burial contexts at the Mounds Plantation and George C. Davis sites where stratigraphy dictates differing temporal positions. There is an important cultural distinction between contexts at Mounds Plantation and George C. Davis, in that all of the Gahagan bifaces from Mounds Plantation were interred with an individual burial (Burials 1, 2, 5, and 8), and all of the Gahagan bifaces from George C. Davis articulate with a cache included as part of two group burials (Features 119 and 134). The information gathered from the analysis provides valuable insights with regard to _design intent_ (associated with central Texas makers) and aesthetic preference (associated with Caddo users) that articulate with Gahagan bifaces at differing temporal intervals.
